/**
 * roleCodes.ts | the sixteen role codes, in canonical order.
 *
...
export const ROLE_CODES_MAIN = Object.freeze([
  'AAE',
  'FDE',
  'FS',
  'BE',
...
export const ROLE_CODES_ALL: readonly string[] = Object.freeze([
  ...ROLE_CODES_MAIN,
  ...ROLE_CODES_EARLY,
]);
